...
function AjaxDemoEmp() {
    ...
    return (<>
        ...
        <button type="submit" onClick={getEmployeesButton_click}  >Get Employees</button>
        <button type="submit" onClick={addEmployeeButton_click}  >Add Employees</button>
        <button type="submit" onClick={updateEmployeeButton_click} >Update Employee</button>
        <hr />
